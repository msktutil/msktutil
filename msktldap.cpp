                                    ...
                                    const char **attrs)
{
    std::string filter = sform("(&(|(objectCategory=Computer)"
                               "(objectCategory=User)(objectCategory=msDS-ManagedServiceAccount)(objectCategory=msDS-GroupManagedServiceAccount))(sAMAccountName=%s))",
...
{
    std::string filter = sform("(&(|(objectCategory=Computer)"
                               "(objectCategory=User)(objectCategory=msDS-ManagedServiceAccount)(objectCategory=msDS-GroupManagedServiceAccount)))"
                               "(sAMAccountName=%s))",
                               flags->sAMAccountName.c_str());
    return flags->ldap->search(flags->base_dn,
                               LDAP_SCOPE_SUBTREE,
